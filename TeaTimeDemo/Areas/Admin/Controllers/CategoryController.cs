...
namespace TeaTimeDemo.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public CategoryController(IUnitOfWork unitOfWork) //constructor: applicationdbcontext(need register) use DI to controller
        {
            _unitOfWork = unitOfWork;
        }
        public IActionResult Index()
        {
            List<Category> objCategoryList = _unitOfWork.Category.GetAll().ToList(); //use _db connect DB catch data
        ...
        public IActionResult Create(Category obj)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _unitOfWork.Save();
                TempData["success"] = "類別新增成功！";//key-value pair
